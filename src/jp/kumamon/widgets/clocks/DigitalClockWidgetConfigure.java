...
public class DigitalClockWidgetConfigure extends Activity {
	private static final String TAG = "DigitalClockWidgetConfigure";
	public static final String CONFIG_DONE = "jp.kumamon.widgets.digitalclock.CONFIG_DONE";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if (extras != null) {
				...
				ampm = hash.get(KumamonDigitalClockWidget.AMPM,
						String.valueOf(mAppWidgetId), false);
				hour = hash.get(KumamonDigitalClockWidget.HOUR,
						String.valueOf(mAppWidgetId), 0);
				minute = hash.get(KumamonDigitalClockWidget.MINUTE,
						String.valueOf(mAppWidgetId), 0);
				minute /= 5;
				set = hash.get(KumamonDigitalClockWidget.SET,
						String.valueOf(mAppWidgetId), false);
				repeat = hash.get(KumamonDigitalClockWidget.REPEAT,
						String.valueOf(mAppWidgetId), false);
			}
	...
	public void onOKButtonClick(View v) {
		try {
			...
			intent.putExtra(KumamonDigitalClockWidget.AMPM, ampm);
			intent.putExtra(KumamonDigitalClockWidget.HOUR, hour);
			intent.putExtra(KumamonDigitalClockWidget.MINUTE, minute * 5);
			intent.putExtra(KumamonDigitalClockWidget.SET, set);
			intent.putExtra(KumamonDigitalClockWidget.REPEAT, repeat);
