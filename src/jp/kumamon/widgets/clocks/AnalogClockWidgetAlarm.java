...
public class AnalogClockWidgetAlarm extends Activity {
	private static final String TAG = "AnalogClockWidgetAlarm";
	public static final String ALARM_DONE = "jp.kumamon.widgets.analogclock.ALARM_DONE";
