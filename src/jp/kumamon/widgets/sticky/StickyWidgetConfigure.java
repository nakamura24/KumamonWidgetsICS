...
public class StickyWidgetConfigure extends Activity {
	...
	public static final String CONFIG_DONE = "jp.kumamon.widgets.sticky.CONFIG_DONE";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			setContentView(R.layout.sticky_widget_configure);
	...
	public void onOKButtonClick(View v) {
		try {
			...
			intent.putExtra(KumamonStickyWidget.ICON, mIcon);
			intent.putExtra(KumamonStickyWidget.BACK, mBack);
			intent.putExtra(KumamonStickyWidget.COMMENT, mComment);
