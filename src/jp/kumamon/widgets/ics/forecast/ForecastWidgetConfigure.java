...
public class ForecastWidgetConfigure extends Activity {
	...
	public static final String CONFIG_DONE = "jp.kumamonforecastwidget.CONFIG_DONE";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Log.d(TAG,
					"getId - id=" + String.valueOf(id) + " mPref="
							+ String.valueOf(mPref) + " mCity="
							+ String.valueOf(mCity));

			setContentView(R.layout.ics_forecast_widget_configure);
			getWindow().setLayout(LayoutParams.MATCH_PARENT,
					LayoutParams.WRAP_CONTENT);

			Spinner spinner1 = (Spinner) findViewById(R.id.isc_spinner_pref);
			...
			setSpinner2(cityEntries.getPrefIds().get(mPref));
			CheckBox checkBox = (CheckBox) findViewById(R.id.ics_checkBox_only);
			checkBox.setChecked(hash.get(ForecastWidgetService.ONLYFORECAST,
					false));
	...
	private void setSpinner2(int pref) {
		...
		try {
			Spinner spinner2 = (Spinner) findViewById(R.id.ics_spinner_city);
			ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
					android.R.layout.simple_spinner_item);
	...
	public void onOKButtonClick(View v) {
		try {
			...
			StaticHash hash = new StaticHash(this);
			CheckBox checkBox = (CheckBox) findViewById(R.id.ics_checkBox_only);
			hash.put(ForecastWidgetService.ONLYFORECAST, checkBox.isChecked());
